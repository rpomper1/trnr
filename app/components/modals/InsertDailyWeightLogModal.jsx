...
export default function InsertDailyWeightLogModal({ traineeId, onClose }) {
  return (
    <Modal isOpen={true} onClose={onClose}>
      <ModalContent>
        {(onClose) => (
          <Form method="post" action="/trainee?index">
            <ModalHeader className="flex flex-col gap-1">
              Insert Daily Weight Log for {new Date().toLocaleDateString()}
            </ModalHeader>
            <ModalBody>
              <Input
                className="hidden"
